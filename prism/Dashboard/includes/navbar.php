                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box text-center">
                            <a href="index.php" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="assets/images/logo-sm1.png" alt="logo-sm-dark" height="48">
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/images/logo-dark1.png" alt="logo-dark" height="50">
                                </span>
                            </a>

                            <a href="index.php" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="assets/images/logo-sm1.png" alt="logo-sm-light" height="48">
                                </span>
                                <span class="logo-lg">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-none d-sm-inline-block">
                            <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                                ...
                                <img class="" src="assets/images/flags/Pakistan.png" alt="Header Language" height="16">
                            </button>
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?php echo 'assets/images/admin_img/'.  $_SESSION['admin_img']?>"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1"><?php echo $_SESSION["admin_name"]?></span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="admin_profile.php"><i class="ri-user-line align-middle me-1"></i>
                                    Profile</a>
