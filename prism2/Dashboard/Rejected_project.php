                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Rejected Projects</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['c_name'] ?></td>
                                                ...
                                                ?></td>
                                                 ...
                                                 <a href="project-restore.php?viewid=<?php echo $row['project_id'];?>"
                                                    class="btn btn-outline-success btn-lg btn-rounded waves-effect waves-light"><i class="fa-solid fa-arrow-rotate-left"></i></a>
