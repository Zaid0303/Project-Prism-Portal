        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    ?>
                    <img class="rounded-circle header-profile-user" src="<?php echo $userImage; ?>">
                    <span class="d-none d-xl-inline-block ms-1"><?php echo $_SESSION["user_name"] ?></span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="user_profile.php"><i class="ri-user-line align-middle me-1"></i>
                        Profile</a>
