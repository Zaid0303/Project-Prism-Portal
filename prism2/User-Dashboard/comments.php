...
// Assuming user ID is stored in a session variable
                    ...
                    WHERE p.user_id = '$user_id'"; // Only fetch comments on the logged-in user's projects
                                        ...
                                        if (!$fetch_user_result) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($fetch_user_result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo "../User-Dashboard/assets/images/project_img/" . htmlspecialchars($row['project_img']); ?>"
